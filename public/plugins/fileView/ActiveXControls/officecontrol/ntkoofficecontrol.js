...
var codebase="officecontrol/ofctnewclsid.cab#version=5,0,4,0";
...
document.write('<param name="MakerCaption" value="上海数慧系统技术有限公司">');
document.write('<param name="MakerKey" value="AB377D79A7F9A3BCF2E49CBB5210CC1F2DCE04AD">');
document.write('<param name="ProductCaption" value="上海数慧系统技术有限公司某某测试用户"> ');
document.write('<param name="ProductKey" value="4E4775D17680C526CAA61114667576520CCA4477">');
...
document.write('_MakerCaption="上海数慧系统技术有限公司"');
document.write('_MakerKey="AB377D79A7F9A3BCF2E49CBB5210CC1F2DCE04AD"');
document.write('_ProductCaption="上海数慧系统技术有限公司某某测试用户" ');
document.write('_ProductKey="4E4775D17680C526CAA61114667576520CCA4477"');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web FireFox跨浏览器插件。请点击<a href="">安装组件</a></SPAN>   ');
		document.write('</object>   ');
...
document.write('_ProductKey="4E4775D17680C526CAA61114667576520CCA4477"');
		...
		document.write('<SPAN STYLE="color:red">尚未安装NTKO Web Chrome跨浏览器插件。请点击<a href="">安装组件</a></SPAN>   ');
		document.write('</object>');
	}else if (Sys.opera){
